<x-app-layout>
    <div class="p-4 space-y-4">
        <h1 class="text-2xl font-bold">Tạo ca làm</h1>
        ...
        >
            ...
            <div>
                ...
                <input
                    ...
                    type="number"
                    value="{{ old('late_after_minutes', 0) }}"
                    class="w-full mt-1 rounded-xl border-gray-300"
                    min="0"
                    required
                >
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            max="1440"
                            value="{{ old('checkin_open_before_minutes', 60) }}"
                            class="w-full mt-1 rounded-xl border-gray-300"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            max="1440"
                            value="{{ old('checkin_close_after_minutes', 240) }}"
                            class="w-full mt-1 rounded-xl border-gray-300"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            max="1440"
                            value="{{ old('checkout_min_after_checkin_minutes', 3) }}"
                            class="w-full mt-1 rounded-xl border-gray-300"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            max="1440"
                            value="{{ old('checkout_close_after_shift_end_minutes') }}"
                            class="w-full mt-1 rounded-xl border-gray-300"
