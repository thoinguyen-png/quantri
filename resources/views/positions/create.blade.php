    ...
    <div class="mx-auto max-w-3xl space-y-5 p-4 sm:p-6">
        ...
        <section class="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <p class="text-sm font-bold text-indigo-600">Thêm mới chức vụ</p>
                    <h1 class="mt-1 text-2xl font-black text-slate-950">Tạo Chức Vụ Mới</h1>
                    <p class="mt-1 text-sm text-slate-500">
                        Khai báo tên tiếng Việt, tên tiếng Anh in thẻ và chọn nhóm quyền hạn tương ứng.
                    </p>
                </div>
                <a
            ...
            <section class="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6 space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="code"
                        value="{{ old('code') }}"
                        placeholder="Để trống hệ thống sẽ tự sinh (VD: tong_quan_ly, bep...)"
                    ...
                    >
                    <p class="mt-1 text-xs text-slate-500">Chữ cái không dấu, viết thường, ngăn cách bằng dấu gạch dưới.</p>
                </div>
                        ...
                        @foreach ([
                            ...
                            <label class="flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 p-4 hover:border-indigo-300 hover:bg-indigo-50/30 transition">
                                <input
                                    ...
                                    name="system_role"
                                    value="{{ $roleKey }}"
                                    @checked(old('system_role', 'staff') === $roleKey)
