...
<meta name="apple-mobile-web-app-title" content="{{ config('app.name', 'Quản trị') }}">
...
@vite([
    ...
    'resources/css/rating-qr-management.css',
    'resources/css/rating-notifications.css',
    'resources/js/app.js',
    'resources/js/rating-qr-management.js',
    'resources/js/rating-notifications.js',
])
